...
**content** | [**Array&lt;ApplicationResponse&gt;**](ApplicationResponse.md) |  | [optional] [default to undefined]
...
```typescript
import { PageApplicationResponse } from './api';

const instance: PageApplicationResponse = {
    totalElements,
    totalPages,
    first,
    last,
